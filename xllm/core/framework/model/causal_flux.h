...
class CausalFLUX : public torch::nn::Module {
 public:
  ~CausalFLUX() override = default;
...
class CausalFLUXImpl : public CausalFLUX {
 public:
  CausalFLUXImpl(Model model, const torch::TensorOptions& options)
