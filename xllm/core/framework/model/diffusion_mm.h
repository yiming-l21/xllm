...
class DiffusionMM : public torch::nn::Module {
 public:
  ~DiffusionMM() override = default;
...
class DiffusionMMImpl : public DiffusionMM {
 public:
  DiffusionMMImpl(Model model, const torch::TensorOptions& options)
